...
For the list of accessible variables for the template, see the struct values here: https://godoc.org/github.com/hasura/hasuractl/pkg/minikube/cmd/minikube/cmd/config#ConfigViewTemplate`)
