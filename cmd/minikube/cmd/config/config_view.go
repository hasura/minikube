...
For the list of accessible variables for the template, see the struct values here: https://godoc.org/gitlab.com/hasura/hasuractl-go/pkg/minikube/cmd/minikube/cmd/config#ConfigViewTemplate`)
