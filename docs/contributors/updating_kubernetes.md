...
5. Update godeps
 ...
 ```shell
 cd $GOPATH/src/github.com/hasura/hasuractl-go/pkg/minikube
 ...
 -X github.com/hasura/hasuractl-go/pkg/minikube/vendor/k8s.io/kubernetes/pkg/version.gitCommit=caf9a4d87700ba034a7b39cced19bd5628ca6aa3 -X github.com/hasura/hasuractl-go/pkg/minikube/vendor/k8s.io/kubernetes/pkg/version.gitVersion=v1.3.0-beta.2 -X github.com/hasura/hasuractl-go/pkg/minikube/vendor/k8s.io/kubernetes/pkg/version.gitTreeState=clean
```

The `-X github.com/hasura/hasuractl-go/pkg/minikube/vendor/k8s.io/kubernetes/pkg/version.gitVersion` flag should contain the right tag.
