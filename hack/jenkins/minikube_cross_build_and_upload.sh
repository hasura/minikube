...
GOOS=darwin GOARCH=amd64 go test -c github.com/hasura/hasuractl/pkg/minikube/test/integration --tags=integration -o out/e2e-darwin-amd64
GOOS=linux GOARCH=amd64 go test -c github.com/hasura/hasuractl/pkg/minikube/test/integration --tags=integration -o out/e2e-linux-amd64
GOOS=windows GOARCH=amd64 go test -c github.com/hasura/hasuractl/pkg/minikube/test/integration --tags=integration -o out/e2e-windows-amd64.exe
